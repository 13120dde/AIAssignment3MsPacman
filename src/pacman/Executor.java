...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);
		...
		*/
		...
		//exec.runGameTimed(new pacman.controllers.id3Controller.MsPacmanID3(),new StarterGhosts(),visual);
	 ...
	 */
	public void runGameTimedRecorded(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,boolean visual, int delay, String fileName)
	{
    ...
    {
        replayGame(fileName, DELAY, visual);
    }

    public void replayGame(String fileName,int delay, boolean visual)
	{
